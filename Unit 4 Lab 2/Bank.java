...
public class Bank{
     ...
     //Is the bank at capacity for clients?
      ...
      //There is room for a new client
         ...
         /*******************************************************************************
           ...
           the account number.
          ********************************************************************************/
         System.out.print(clients[numActiveAccounts]);
   ...
   public static void deposit(BankClient client){
      ...
      ********************************************************************************/
      ...
      {
      client.deposit(amt);
      System.out.print("Deposit Amount: " +  NumberFormat.getCurrencyInstance().format(amt) + "\nAccount Number: " + client.getAccount() + "\nNew Balance: " + client.getBalance());
      }
      else
      {
      System.out.print("ERROR: YOU CANNOT DEPOSIT NEGATIVE MONEY");
      }
      //END INSERTION 4
   ...
   public static void withdraw(BankClient client){
      ...
      while(true){
         try{
            ...
            System.out.println("\nERROR: Please make sure that your amount contains a numerical value");
         }
      }
      //end formatting loop
      ...
      ********************************************************************************/
      ...
      {
         System.out.print("Current Balance: " + client.getBalance() + "\nERROR: INSUFFICIENT FUNDS TO WITHDRAW THE AMOUNT REQUESTED");
      }
      else
      {
         System.out.print("Withdraw Amount: " + NumberFormat.getCurrencyInstance().format(amt) + "\nAccount Number: " + client.getAccount() + "\nNew Balance: " + client.getBalance());
      //END INSERTION 5
      }
      } 
      else
      {
      System.out.print("\nEERROR: Please make sure that your amount contains a numerical value");
      }
   }
   /**
   ...
   public static void searchExisting(){
      ...
      *******************************************************************/ 
      int index = 0;
      boolean corrAcc = false;
      boolean corrPin = false;
      for(int i = 0; i < numActiveAccounts; i++)
      {
      
         if(clients[i].getAccount().equals(acct))
         {
            index = i;
            corrAcc = true;
            i = numActiveAccounts + 10;
         }
      }
      if(corrAcc)
      {
         corrPin = pinCheck(clients[index]);
         if(corrPin)
         {
            accessAccount(clients[index]);
         }
      }
      else
      {
         System.out.print("Account was not found :( Womp Womp.");
      }
